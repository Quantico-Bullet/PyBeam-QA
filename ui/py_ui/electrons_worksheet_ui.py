...
class Ui_QElectronsWorksheet(object):
    def setupUi(self, QElectronsWorksheet):
        ...
        QElectronsWorksheet.setSizePolicy(sizePolicy)
        QElectronsWorksheet.setFocusPolicy(Qt.NoFocus)
        QElectronsWorksheet.setAutoFillBackground(False)
        self.gridLayout = QGridLayout(QElectronsWorksheet)
...
"font-weight: bold")
        ...
        self.horizontalLayout_4.addWidget(self.kSLE)

        self.ks_status_icon = QLabel(self.calSummaryScroll)
        self.ks_status_icon.setObjectName(u"ks_status_icon")

        self.horizontalLayout_4.addWidget(self.ks_status_icon)


        self.corrFactorFL_2.setLayout(4, QFormLayout.FieldRole, self.horizontalLayout_4)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.outcomeLE.sizePolicy().hasHeightForWidth())
        self.outcomeLE.setSizePolicy(sizePolicy3)
...
"")
        ...
        self.siteDataWidget = QWidget(QElectronsWorksheet)
        ...
        self.sectionOneFL.setRowWrapPolicy(QFormLayout.DontWrapRows)
        ...
        self.label = QLabel(self.sectionOneGB)
        self.label.setObjectName(u"label")
        sizePolicy2.setHeightForWidth(self.label.sizePolicy().hasHeightForWidth())
        self.label.setSizePolicy(sizePolicy2)

        self.sectionOneFL.setWidget(3, QFormLayout.LabelRole, self.label)

        self.beamQR50VL = QVBoxLayout()
        self.beamQR50VL.setObjectName(u"beamQR50VL")
        self.r50SourceHL = QHBoxLayout()
        ...
        self.ionCurveRadioButton = QRadioButton(self.sectionOneGB)
        self.r50SourceGroup = QButtonGroup(QElectronsWorksheet)
        self.r50SourceGroup.setObjectName(u"r50SourceGroup")
        self.r50SourceGroup.addButton(self.ionCurveRadioButton)
        self.ionCurveRadioButton.setObjectName(u"ionCurveRadioButton")
        sizePolicy2.setHeightForWidth(self.ionCurveRadioButton.sizePolicy().hasHeightForWidth())
        self.ionCurveRadioButton.setSizePolicy(sizePolicy2)
        self.ionCurveRadioButton.setChecked(True)

        self.r50SourceHL.addWidget(self.ionCurveRadioButton)

        self.doseCurveRadioButton = QRadioButton(self.sectionOneGB)
        self.r50SourceGroup.addButton(self.doseCurveRadioButton)
        self.doseCurveRadioButton.setObjectName(u"doseCurveRadioButton")
        sizePolicy2.setHeightForWidth(self.doseCurveRadioButton.sizePolicy().hasHeightForWidth())
        self.doseCurveRadioButton.setSizePolicy(sizePolicy2)

        self.r50SourceHL.addWidget(self.doseCurveRadioButton)


        self.beamQR50VL.addLayout(self.r50SourceHL)

        self.formLayout = QFormLayout()
        self.formLayout.setObjectName(u"formLayout")
        self.measuredR50LE = QLineEdit(self.sectionOneGB)
        self.measuredR50LE.setObjectName(u"measuredR50LE")
        sizePolicy2.setHeightForWidth(self.measuredR50LE.sizePolicy().hasHeightForWidth())
        self.measuredR50LE.setSizePolicy(sizePolicy2)
        self.measuredR50LE.setMinimumSize(QSize(100, 0))
        self.measuredR50LE.setMaximumSize(QSize(100, 16777215))

        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.measuredR50LE)
        ...
        self.beamQR50VL.addLayout(self.formLayout)


        self.sectionOneFL.setLayout(3, QFormLayout.FieldRole, self.beamQR50VL)

        self.beamQualityLabel = QLabel(self.sectionOneGB)
        self.beamQualityLabel.setObjectName(u"beamQualityLabel")

        self.sectionOneFL.setWidget(4, QFormLayout.LabelRole, self.beamQualityLabel)

        self.beamQualityLE = QLineEdit(self.sectionOneGB)
        self.beamQualityLE.setObjectName(u"beamQualityLE")
        sizePolicy2.setHeightForWidth(self.beamQualityLE.sizePolicy().hasHeightForWidth())
        self.beamQualityLE.setSizePolicy(sizePolicy2)
        self.beamQualityLE.setMinimumSize(QSize(100, 0))
        self.beamQualityLE.setMaximumSize(QSize(100, 16777215))
        self.beamQualityLE.setReadOnly(True)

        self.sectionOneFL.setWidget(4, QFormLayout.FieldRole, self.beamQualityLE)

        self.calibSetupLabel = QLabel(self.sectionOneGB)
        self.calibSetupLabel.setObjectName(u"calibSetupLabel")

        self.sectionOneFL.setWidget(5, QFormLayout.LabelRole, self.calibSetupLabel)

        self.calSetupHL = QHBoxLayout()
        self.calSetupHL.setObjectName(u"calSetupHL")
        self.ssdRadioButton = QRadioButton(self.sectionOneGB)
        self.calibSetupGroup = QButtonGroup(QElectronsWorksheet)
        ...
        self.sadRadioButton.setEnabled(False)

        self.calSetupHL.addWidget(self.sadRadioButton)


        self.sectionOneFL.setLayout(5, QFormLayout.FieldRole, self.calSetupHL)

        self.refPhantomLabel = QLabel(self.sectionOneGB)
        self.refPhantomLabel.setObjectName(u"refPhantomLabel")

        self.sectionOneFL.setWidget(6, QFormLayout.LabelRole, self.refPhantomLabel)
        ...
        self.sectionOneFL.setWidget(6, QFormLayout.FieldRole, self.refPhantomComboB)

        self.refFieldSizeLabel = QLabel(self.sectionOneGB)
        self.refFieldSizeLabel.setObjectName(u"refFieldSizeLabel")

        self.sectionOneFL.setWidget(7, QFormLayout.LabelRole, self.refFieldSizeLabel)
        ...
        self.sectionOneFL.setLayout(7, QFormLayout.FieldRole, self.refFieldSizeHL)
        ...
        self.refDistanceLE.setReadOnly(True)
        ...
        self.sectionOneFL.setWidget(9, QFormLayout.LabelRole, self.refDepthLabel)
        ...
        self.sectionOneFL.setLayout(9, QFormLayout.FieldRole, self.refDepthHL)
        ...
        sizePolicy.setHeightForWidth(self.wSleeveLabel.sizePolicy().hasHeightForWidth())
        self.wSleeveLabel.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.pWinLabel.sizePolicy().hasHeightForWidth())
        self.pWinLabel.setSizePolicy(sizePolicy)
        ...
        self.beamQualityGroup = QButtonGroup(QElectronsWorksheet)
        ...
        sizePolicy.setHeightForWidth(self.refPressureLabel.sizePolicy().hasHeightForWidth())
        self.refPressureLabel.setSizePolicy(sizePolicy)
        ...
        self.calibPolarityGroup = QButtonGroup(QElectronsWorksheet)
        ...
        self.userPolarityGroup = QButtonGroup(QElectronsWorksheet)
        ...
        self.calibSeparateGroup = QButtonGroup(QElectronsWorksheet)
        ...
        self.beamTypeGroup = QButtonGroup(QElectronsWorksheet)
        ...
        sizePolicy3.setHeightForWidth(self.tmrLE.sizePolicy().hasHeightForWidth())
        self.tmrLE.setSizePolicy(sizePolicy3)
        ...
        self.gen_report_btn = QPushButton(QElectronsWorksheet)
...
"}")
        ...
        QMetaObject.connectSlotsByName(QElectronsWorksheet)
    # setupUi
    ...
    def retranslateUi(self, QElectronsWorksheet):
        ...
        self.kElecLE.setPlaceholderText(QCoreApplication.translate("QElectronsWorksheet", u"N/A", None))
        self.kTPLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">TP </span>:</p></body></html>", None))
        self.kTPLE.setText("")
        self.kTPLE.setPlaceholderText(QCoreApplication.translate("QElectronsWorksheet", u"N/A", None))
        self.kPolLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">pol </span>:</p></body></html>", None))
        ...
        self.zmaxDoseLE.setPlaceholderText(QCoreApplication.translate("QElectronsWorksheet", u"N/A", None))
        self.outcomeLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:700;\">Outcome</span></p></body></html>", None))
        self.outcomeLE.setPlaceholderText(QCoreApplication.translate("QElectronsWorksheet", u"N/A", None))
        self.institutionLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Institution:", None))
        ...
        self.dateDE.setDisplayFormat(QCoreApplication.translate("QElectronsWorksheet", u"dd MMM yyyy", None))
        ...
        self.nomAccPotUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"MeV", None))
        self.nomDoseRateLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Nominal dose rate:", None))
        self.nomDoseRateUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"MU/min", None))
        self.label.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Measured R<span style=\" font-size:12pt; vertical-align:sub;\">50</span>:</p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("QElectronsWorksheet", u"Obtained from:", None))
        self.ionCurveRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Ionization curves", None))
        self.doseCurveRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Dose curves", None))
        self.r50Unit.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>g/cm<span style=\" font-size:11pt; vertical-align:super;\">2</span></p></body></html>", None))
        self.beamQualityLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Beam quality, Q (R<span style=\" font-size:12pt; vertical-align:sub;\">50,w</span>) :</p></body></html>", None))
        self.calibSetupLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Set up:", None))
        self.ssdRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"SSD", None))
        self.sadRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"SAD", None))
        self.refPhantomLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Reference phantom:", None))
        self.refPhantomComboB.setItemText(0, QCoreApplication.translate("QElectronsWorksheet", u"Water", None))
        ...
        self.refDistanceLE.setText(QCoreApplication.translate("QElectronsWorksheet", u"100", None))
        ...
        self.calibFactorLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Calibration factor <span style=\" font-style:italic;\">N</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">D,w,Qo </span>:</p></body></html>", None))
        self.calibFactorUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"Gy/nC", None))
        self.calibLabLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Calibration laboratory:", None))
        self.chamberCalibDateLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Calibration date:", None))
        self.chamberCalibDE.setDisplayFormat(QCoreApplication.translate("QElectronsWorksheet", u"dd MMM yyyy", None))
        self.chamberWallMatLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Chamber wall", None))
        self.cWallMaterialLE.setText(QCoreApplication.translate("QElectronsWorksheet", u"material:", None))
        self.cWallThickLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"thickness:", None))
        self.cWallThickUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>g/cm<span style=\" font-size:11pt; vertical-align:super;\">2</span></p></body></html>", None))
        self.wSleeveLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Waterproof sleeve", None))
        self.sleeveMatLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"material:", None))
        self.wsSleeveThickLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"thickness:", None))
        self.wSleeveThickUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>g/cm<span style=\" font-size:11pt; vertical-align:super;\">2</span></p></body></html>", None))
        self.pWinLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Phantom window:", None))
        self.phantomWinMatLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"material:", None))
        self.pWinThickLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"thickness:", None))
        ...
        self.refTempLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Temperature, <span style=\" font-style:italic;\">T</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">o</span> :</p></body></html>", None))
        self.refTempUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-size:11pt; vertical-align:super;\">o</span><span style=\" font-size:11pt;\">C</span></p></body></html>", None))
        self.refHumidityLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Relative humidity, <span style=\" font-style:italic;\">rH</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">o</span> :</p></body></html>", None))
        self.refHumidityUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"%", None))
        self.polarPotV1.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Polarizing potential, <span style=\" font-style:italic;\">V</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">1 </span>:</p></body></html>", None))
        self.polarPotV1Unit.setText(QCoreApplication.translate("QElectronsWorksheet", u"V", None))
        self.calibPolarLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Calibration polarity:", None))
        self.calPosPolarRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Positive (+)", None))
        self.calNegPolarRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Negative (-)", None))
        self.userPolarityLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"User polarity:", None))
        self.userPosPolarRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Positive (+)", None))
        self.userNegPolarRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Negative (-)", None))
        self.corrPolarEffCheckB.setText(QCoreApplication.translate("QElectronsWorksheet", u"Corrected for polarity effect", None))
        self.electModelLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Electrometer model:", None))
        self.electSerialNoLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Electrometer serial No:", None))
        self.elecCalLabLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Calibration laboratory:", None))
        self.electCalDateLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Calibration date:", None))
        self.electCalDateDE.setDisplayFormat(QCoreApplication.translate("QElectronsWorksheet", u"dd MMM yyyy", None))
        self.electRangeSettLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Range setting:", None))
        self.calibSeparateLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Calibrated separately from chamber:", None))
        self.calibSepYesRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Yes", None))
        self.calibSepNoRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"No", None))
        self.sectionThreeGB.setTitle(QCoreApplication.translate("QElectronsWorksheet", u"3. Dosimeter reading and correction for influence quantities", None))
        self.rawDosReadLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Raw dosimeter reading at <span style=\" font-style:italic;\">V</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">1</span> :</p></body></html>", None))
        self.rawDosReadUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"nC", None))
        self.corrLinacMULabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Corresponding linac monitor units:", None))
        self.corrLinacMUUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"MU", None))
        self.ratioReadMULabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Ratio of raw reading and monitor units:", None))
        self.ratioReadMUUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"nC/MU", None))
        self.tempPressCorrLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(A)</span><span style=\" font-style:italic; text-decoration: underline;\"> Temp. and pressure correction</span></p></body></html>", None))
        self.userPressureLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Pressure:", None))
        self.userPressureUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"kPa", None))
        self.userTempLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Temperature:", None))
        self.userTempUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-size:11pt; vertical-align:super;\">o</span>C</p></body></html>", None))
        self.userHumidityLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Relative humidity:", None))
        self.userHumidityUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"%", None))
        self.polarCorrLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(B)</span><span style=\" font-style:italic; text-decoration: underline;\"> Polarity correction</span></p></body></html>", None))
        self.readMPosLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Reading at +V<span style=\" font-size:12pt; vertical-align:sub;\">1 </span>(<span style=\" font-style:italic;\">M</span><span style=\" font-size:12pt; vertical-align:sub;\">+</span>) :</p></body></html>", None))
        self.readMPosUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"nC", None))
        self.readMNegLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Reading at \u208bV<span style=\" font-size:12pt; vertical-align:sub;\">1 </span>(<span style=\" font-style:italic;\">M</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">\u208b</span>) :</p></body></html>", None))
        self.readMNegUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"nC", None))
        self.ionRecombCorrLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(C)</span><span style=\" font-style:italic; text-decoration: underline;\"> Ion recombination correction</span></p></body></html>", None))
        self.normVoltageLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Voltage <span style=\" font-style:italic;\">V</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">1 </span>(normal):</p></body></html>", None))
        self.normVoltageUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"V", None))
        self.normReadLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Reading <span style=\" font-style:italic;\">M</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">1 </span>:</p></body></html>", None))
        self.normReadUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"nC", None))
        self.redVoltageLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Voltage <span style=\" font-style:italic;\">V</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">2 </span>(reduced):</p></body></html>", None))
        self.redVoltageUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"V", None))
        self.redReadLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Reading <span style=\" font-style:italic;\">M</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">2 </span>:</p></body></html>", None))
        self.redReadUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"nC", None))
        self.beamTypeLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"Beam type:", None))
        self.pulsedRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Pulsed", None))
        self.pulsedScanRadioButton.setText(QCoreApplication.translate("QElectronsWorksheet", u"Pulsed-scanned", None))
        self.electmeterCorrLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic; text-decoration: underline;\">(D) Electrometer correction:</span></p></body></html>", None))
        self.kElecLabel_2.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">elec </span>:</p></body></html>", None))
        self.sectionFourGB.setTitle(QCoreApplication.translate("QElectronsWorksheet", u"4. Absorbed dose to water at the depth of dose maximum", None))
        self.depthDMaxLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>Depth of dose maximum, <span style=\" font-style:italic;\">z</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">max </span>:</p></body></html>", None))
        self.depthDMaxUnit.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p>g/cm<span style=\" font-size:11pt; vertical-align:super;\">2</span></p></body></html>", None))
        self.ssdSetupLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic; text-decoration: underline;\">SSD set-up</span></p></body></html>", None))
        self.pddLabel.setText(QCoreApplication.translate("QElectronsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">PDD</span> at <span style=\" font-style:italic;\">z</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">ref </span>:</p></body></html>", None))
        ...
        self.gen_report_btn.setText(QCoreApplication.translate("QElectronsWorksheet", u"Generate report", None))
    # retranslateUi
