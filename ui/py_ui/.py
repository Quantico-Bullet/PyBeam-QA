...
class Ui_QPhotonsWorksheet(object):
    def setupUi(self, QPhotonsWorksheet):
        ...
        QPhotonsWorksheet.resize(1109, 556)
        ...
        self.worksheetGrid.setSizeConstraint(QLayout.SetDefaultConstraint)
        self.worksheetGrid.setHorizontalSpacing(40)
        ...
        sizePolicy1.setHeightForWidth(self.siteDataWidget.sizePolicy().hasHeightForWidth())
        self.siteDataWidget.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.institutionLabel.sizePolicy().hasHeightForWidth())
        self.institutionLabel.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.institutionLE.sizePolicy().hasHeightForWidth())
        self.institutionLE.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.userLabel.sizePolicy().hasHeightForWidth())
        self.userLabel.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.userLE.sizePolicy().hasHeightForWidth())
        self.userLE.setSizePolicy(sizePolicy3)
        ...
        sizePolicy1.setHeightForWidth(self.dateDE.sizePolicy().hasHeightForWidth())
        self.dateDE.setSizePolicy(sizePolicy1)
        ...
        self.worksheetScrollArea.setSizeAdjustPolicy(QAbstractScrollArea.AdjustIgnored)
        self.worksheetScrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 605, 1909))
        ...
        sizePolicy6.setHeightForWidth(self.sectionOneGB.sizePolicy().hasHeightForWidth())
        self.sectionOneGB.setSizePolicy(sizePolicy6)
        ...
        sizePolicy1.setHeightForWidth(self.linacNameLE.sizePolicy().hasHeightForWidth())
        self.linacNameLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy7.setHeightForWidth(self.nomAccPotLE.sizePolicy().hasHeightForWidth())
        self.nomAccPotLE.setSizePolicy(sizePolicy7)
        ...
        self.nomAccPotLE.setInputMethodHints(Qt.ImhFormattedNumbersOnly)
        self.nomAccPotLE.setInputMask(u"")
        self.nomAccPotLE.setMaxLength(32767)
        self.nomAccPotLE.setEchoMode(QLineEdit.Normal)
        ...
        self.nomAccPotLE.setCursorMoveStyle(Qt.LogicalMoveStyle)
        ...
        sizePolicy8.setHeightForWidth(self.nomAccPotUnit.sizePolicy().hasHeightForWidth())
        self.nomAccPotUnit.setSizePolicy(sizePolicy8)
        ...
        sizePolicy1.setHeightForWidth(self.nomDoseRateLE.sizePolicy().hasHeightForWidth())
        self.nomDoseRateLE.setSizePolicy(sizePolicy1)
        ...
        self.refPhantomLE = QLineEdit(self.sectionOneGB)
        self.refPhantomLE.setObjectName(u"refPhantomLE")
        self.refPhantomLE.setEnabled(True)
        sizePolicy1.setHeightForWidth(self.refPhantomLE.sizePolicy().hasHeightForWidth())
        self.refPhantomLE.setSizePolicy(sizePolicy1)
        self.refPhantomLE.setMinimumSize(QSize(175, 0))
        self.refPhantomLE.setMaximumSize(QSize(175, 16777215))
        self.refPhantomLE.setFrame(True)
        self.refPhantomLE.setReadOnly(True)

        self.sectionOneFL.setWidget(5, QFormLayout.FieldRole, self.refPhantomLE)
        ...
        sizePolicy1.setHeightForWidth(self.reffieldSizeComboB.sizePolicy().hasHeightForWidth())
        self.reffieldSizeComboB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.refDistanceLE.sizePolicy().hasHeightForWidth())
        self.refDistanceLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.refDepthLE.sizePolicy().hasHeightForWidth())
        self.refDepthLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.IonChamberModelComboB.sizePolicy().hasHeightForWidth())
        self.IonChamberModelComboB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.chamberSerialNoLE.sizePolicy().hasHeightForWidth())
        self.chamberSerialNoLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.calibFactorLE.sizePolicy().hasHeightForWidth())
        self.calibFactorLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.calibLabLE.sizePolicy().hasHeightForWidth())
        self.calibLabLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.chamberCalibDE.sizePolicy().hasHeightForWidth())
        self.chamberCalibDE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.cWallMatLE.sizePolicy().hasHeightForWidth())
        self.cWallMatLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.cWallThickLE.sizePolicy().hasHeightForWidth())
        self.cWallThickLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.wSleeveMatlLE.sizePolicy().hasHeightForWidth())
        self.wSleeveMatlLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.wSleeveThickLE.sizePolicy().hasHeightForWidth())
        self.wSleeveThickLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.pWinMatLabel.sizePolicy().hasHeightForWidth())
        self.pWinMatLabel.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.pWinThickLE.sizePolicy().hasHeightForWidth())
        self.pWinThickLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.refPressureLE.sizePolicy().hasHeightForWidth())
        self.refPressureLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.refTempLE.sizePolicy().hasHeightForWidth())
        self.refTempLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.refHumidityLE.sizePolicy().hasHeightForWidth())
        self.refHumidityLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.polarPotV1LE.sizePolicy().hasHeightForWidth())
        self.polarPotV1LE.setSizePolicy(sizePolicy1)
        ...
        self.sectionTwoFL.setWidget(15, QFormLayout.LabelRole, self.electModelLabel)

        self.electModelLE = QLineEdit(self.sectionTwoGB)
        self.electModelLE.setObjectName(u"electModelLE")
        sizePolicy1.setHeightForWidth(self.electModelLE.sizePolicy().hasHeightForWidth())
        self.electModelLE.setSizePolicy(sizePolicy1)
        self.electModelLE.setMinimumSize(QSize(175, 0))
        self.electModelLE.setMaximumSize(QSize(175, 16777215))

        self.sectionTwoFL.setWidget(15, QFormLayout.FieldRole, self.electModelLE)

        self.electSerialNoLabel = QLabel(self.sectionTwoGB)
        self.electSerialNoLabel.setObjectName(u"electSerialNoLabel")

        self.sectionTwoFL.setWidget(16, QFormLayout.LabelRole, self.electSerialNoLabel)

        self.electSerialNoLE = QLineEdit(self.sectionTwoGB)
        self.electSerialNoLE.setObjectName(u"electSerialNoLE")
        sizePolicy1.setHeightForWidth(self.electSerialNoLE.sizePolicy().hasHeightForWidth())
        self.electSerialNoLE.setSizePolicy(sizePolicy1)
        self.electSerialNoLE.setMinimumSize(QSize(175, 0))
        self.electSerialNoLE.setMaximumSize(QSize(175, 16777215))

        self.sectionTwoFL.setWidget(16, QFormLayout.FieldRole, self.electSerialNoLE)

        self.elecCalLabLabel = QLabel(self.sectionTwoGB)
        self.elecCalLabLabel.setObjectName(u"elecCalLabLabel")

        self.sectionTwoFL.setWidget(17, QFormLayout.LabelRole, self.elecCalLabLabel)
        ...
        sizePolicy1.setHeightForWidth(self.electCalLabLE.sizePolicy().hasHeightForWidth())
        self.electCalLabLE.setSizePolicy(sizePolicy1)
        self.electCalLabLE.setMinimumSize(QSize(350, 0))
        self.electCalLabLE.setMaximumSize(QSize(350, 16777215))

        self.sectionTwoFL.setWidget(17, QFormLayout.FieldRole, self.electCalLabLE)

        self.electCalDateLabel = QLabel(self.sectionTwoGB)
        self.electCalDateLabel.setObjectName(u"electCalDateLabel")

        self.sectionTwoFL.setWidget(18, QFormLayout.LabelRole, self.electCalDateLabel)
        ...
        self.sectionTwoFL.setWidget(18, QFormLayout.FieldRole, self.electCalDateDE)

        self.electRangeSettLabel = QLabel(self.sectionTwoGB)
        self.electRangeSettLabel.setObjectName(u"electRangeSettLabel")

        self.sectionTwoFL.setWidget(19, QFormLayout.LabelRole, self.electRangeSettLabel)

        self.electRangeSettLE = QLineEdit(self.sectionTwoGB)
        self.electRangeSettLE.setObjectName(u"electRangeSettLE")
        sizePolicy7.setHeightForWidth(self.electRangeSettLE.sizePolicy().hasHeightForWidth())
        self.electRangeSettLE.setSizePolicy(sizePolicy7)
        self.electRangeSettLE.setMinimumSize(QSize(175, 0))
        self.electRangeSettLE.setMaximumSize(QSize(175, 16777215))

        self.sectionTwoFL.setWidget(19, QFormLayout.FieldRole, self.electRangeSettLE)
        ...
        self.sectionTwoFL.setLayout(20, QFormLayout.FieldRole, self.calibSeparateFL)
        ...
        sizePolicy8.setHeightForWidth(self.rawDosReadLabel.sizePolicy().hasHeightForWidth())
        self.rawDosReadLabel.setSizePolicy(sizePolicy8)
        ...
        sizePolicy1.setHeightForWidth(self.rawDosReadLE.sizePolicy().hasHeightForWidth())
        self.rawDosReadLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.corrLinacMULE.sizePolicy().hasHeightForWidth())
        self.corrLinacMULE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.ratioReadMULE.sizePolicy().hasHeightForWidth())
        self.ratioReadMULE.setSizePolicy(sizePolicy1)
        ...
        self.sectionThreeFL.setItem(3, QFormLayout.LabelRole, self.verticalSpacer_3)
        ...
        sizePolicy1.setHeightForWidth(self.userPressureLE.sizePolicy().hasHeightForWidth())
        self.userPressureLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.userTempLE.sizePolicy().hasHeightForWidth())
        self.userTempLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.userHumidityLE.sizePolicy().hasHeightForWidth())
        self.userHumidityLE.setSizePolicy(sizePolicy1)
        ...
        self.sectionThreeFL.setItem(5, QFormLayout.LabelRole, self.verticalSpacer_4)
        ...
        sizePolicy1.setHeightForWidth(self.readMPosLE.sizePolicy().hasHeightForWidth())
        self.readMPosLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.readMNegLE.sizePolicy().hasHeightForWidth())
        self.readMNegLE.setSizePolicy(sizePolicy1)
        ...
        self.sectionThreeFL.setItem(7, QFormLayout.LabelRole, self.verticalSpacer_5)
        ...
        sizePolicy1.setHeightForWidth(self.normVoltageLE.sizePolicy().hasHeightForWidth())
        self.normVoltageLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.normReadLE.sizePolicy().hasHeightForWidth())
        self.normReadLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.redVoltageLE.sizePolicy().hasHeightForWidth())
        self.redVoltageLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.redReadLE.sizePolicy().hasHeightForWidth())
        self.redReadLE.setSizePolicy(sizePolicy1)
        ...
        self.beamQualityCorrLabel = QLabel(self.sectionThreeGB)
        self.beamQualityCorrLabel.setObjectName(u"beamQualityCorrLabel")

        self.sectionThreeFL.setWidget(10, QFormLayout.LabelRole, self.beamQualityCorrLabel)

        self.beamQCorrFL = QFormLayout()
        self.beamQCorrFL.setObjectName(u"beamQCorrFL")
        self.beamQCorrFactLabel = QLabel(self.sectionThreeGB)
        self.beamQCorrFactLabel.setObjectName(u"beamQCorrFactLabel")

        self.beamQCorrFL.setWidget(0, QFormLayout.LabelRole, self.beamQCorrFactLabel)

        self.beamQCorrFactLE = QLineEdit(self.sectionThreeGB)
        self.beamQCorrFactLE.setObjectName(u"beamQCorrFactLE")
        sizePolicy1.setHeightForWidth(self.beamQCorrFactLE.sizePolicy().hasHeightForWidth())
        self.beamQCorrFactLE.setSizePolicy(sizePolicy1)
        self.beamQCorrFactLE.setMinimumSize(QSize(100, 0))
        self.beamQCorrFactLE.setMaximumSize(QSize(100, 16777215))

        self.beamQCorrFL.setWidget(0, QFormLayout.FieldRole, self.beamQCorrFactLE)

        self.beamQSourceLabel = QLabel(self.sectionThreeGB)
        self.beamQSourceLabel.setObjectName(u"beamQSourceLabel")

        self.beamQCorrFL.setWidget(1, QFormLayout.LabelRole, self.beamQSourceLabel)

        self.beamQSourceHL = QHBoxLayout()
        self.beamQSourceHL.setObjectName(u"beamQSourceHL")
        self.table6IIIRadioButton = QRadioButton(self.sectionThreeGB)
        self.beamQFSourceGroup = QButtonGroup(QPhotonsWorksheet)
        self.beamQFSourceGroup.setObjectName(u"beamQFSourceGroup")
        self.beamQFSourceGroup.addButton(self.table6IIIRadioButton)
        self.table6IIIRadioButton.setObjectName(u"table6IIIRadioButton")
        self.table6IIIRadioButton.setChecked(True)

        self.beamQSourceHL.addWidget(self.table6IIIRadioButton)

        self.otherSourceRadioButton = QRadioButton(self.sectionThreeGB)
        self.beamQFSourceGroup.addButton(self.otherSourceRadioButton)
        self.otherSourceRadioButton.setObjectName(u"otherSourceRadioButton")

        self.beamQSourceHL.addWidget(self.otherSourceRadioButton)


        self.beamQCorrFL.setLayout(1, QFormLayout.FieldRole, self.beamQSourceHL)


        self.sectionThreeFL.setLayout(10, QFormLayout.FieldRole, self.beamQCorrFL)

        self.verticalSpacer_6 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.sectionThreeFL.setItem(9, QFormLayout.LabelRole, self.verticalSpacer_6)
        ...
        sizePolicy1.setHeightForWidth(self.depthDMaxLE.sizePolicy().hasHeightForWidth())
        self.depthDMaxLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.setupSW.sizePolicy().hasHeightForWidth())
        self.setupSW.setSizePolicy(sizePolicy1)
        self.setupSW.setMinimumSize(QSize(100, 0))
        self.ssdPage = QWidget()
        self.ssdPage.setObjectName(u"ssdPage")
        sizePolicy1.setHeightForWidth(self.ssdPage.sizePolicy().hasHeightForWidth())
        self.ssdPage.setSizePolicy(sizePolicy1)
        ...
        sizePolicy8.setHeightForWidth(self.ssdSetupLabel.sizePolicy().hasHeightForWidth())
        self.ssdSetupLabel.setSizePolicy(sizePolicy8)
        ...
        sizePolicy1.setHeightForWidth(self.pddLabel.sizePolicy().hasHeightForWidth())
        self.pddLabel.setSizePolicy(sizePolicy1)

        self.pddHL.addWidget(self.pddLabel)

        self.pddLE = QLineEdit(self.ssdPage)
        self.pddLE.setObjectName(u"pddLE")
        sizePolicy1.setHeightForWidth(self.pddLE.sizePolicy().hasHeightForWidth())
        self.pddLE.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.pddUnit.sizePolicy().hasHeightForWidth())
        self.pddUnit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.sadPage.sizePolicy().hasHeightForWidth())
        self.sadPage.setSizePolicy(sizePolicy1)
        ...
        sizePolicy8.setHeightForWidth(self.sadSetupLabel.sizePolicy().hasHeightForWidth())
        self.sadSetupLabel.setSizePolicy(sizePolicy8)
        ...
        sizePolicy1.setHeightForWidth(self.tmrLabel.sizePolicy().hasHeightForWidth())
        self.tmrLabel.setSizePolicy(sizePolicy1)

        self.tmrHL.addWidget(self.tmrLabel)

        self.tmrLabel_2 = QLineEdit(self.sadPage)
        self.tmrLabel_2.setObjectName(u"tmrLabel_2")
        sizePolicy9 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy9.setHorizontalStretch(0)
        sizePolicy9.setVerticalStretch(0)
        sizePolicy9.setHeightForWidth(self.tmrLabel_2.sizePolicy().hasHeightForWidth())
        self.tmrLabel_2.setSizePolicy(sizePolicy9)
        self.tmrLabel_2.setMinimumSize(QSize(100, 0))
        self.tmrLabel_2.setMaximumSize(QSize(100, 16777215))

        self.tmrHL.addWidget(self.tmrLabel_2)
        ...
        sizePolicy9.setHeightForWidth(self.calibSummaryWidget.sizePolicy().hasHeightForWidth())
        self.calibSummaryWidget.setSizePolicy(sizePolicy9)
        ...
        sizePolicy1.setHeightForWidth(self.CalibSummaryLabel.sizePolicy().hasHeightForWidth())
        self.CalibSummaryLabel.setSizePolicy(sizePolicy1)
        font1 = QFont()
        font1.setPointSize(13)
        self.CalibSummaryLabel.setFont(font1)
        ...
        self.calibSummaryHLine.setMinimumSize(QSize(300, 0))
        ...
        self.verticalSpacer_7 = QSpacerItem(20, 4, QSizePolicy.Minimum, QSizePolicy.Expanding)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 375, 301))
        sizePolicy11 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.MinimumExpanding)
        sizePolicy11.setHorizontalStretch(0)
        sizePolicy11.setVerticalStretch(0)
        sizePolicy11.setHeightForWidth(self.scrollAreaWidgetContents_2.sizePolicy().hasHeightForWidth())
        self.scrollAreaWidgetContents_2.setSizePolicy(sizePolicy11)
        self.scrollAreaWidgetContents_2.setAutoFillBackground(False)
        self.scrollAreaWidgetContents_2.setStyleSheet(u"background-color: rgba(252, 247, 247, 0);")
        self.verticalLayout_5 = QVBoxLayout(self.scrollAreaWidgetContents_2)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.corrFactorsLabel = QLabel(self.scrollAreaWidgetContents_2)
        self.corrFactorsLabel.setObjectName(u"corrFactorsLabel")
        sizePolicy1.setHeightForWidth(self.corrFactorsLabel.sizePolicy().hasHeightForWidth())
        self.corrFactorsLabel.setSizePolicy(sizePolicy1)
        ...
        self.kElecLabel_2 = QLabel(self.scrollAreaWidgetContents_2)
        ...
        sizePolicy12.setHeightForWidth(self.kElecLabel_2.sizePolicy().hasHeightForWidth())
        self.kElecLabel_2.setSizePolicy(sizePolicy12)
        self.kElecLabel_2.setToolTipDuration(4000)
        self.kElecLabel_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.corrFactorFL_2.setWidget(0, QFormLayout.LabelRole, self.kElecLabel_2)

        self.kElecLE_2 = QLineEdit(self.scrollAreaWidgetContents_2)
        self.kElecLE_2.setObjectName(u"kElecLE_2")
        self.kElecLE_2.setEnabled(True)
        sizePolicy1.setHeightForWidth(self.kElecLE_2.sizePolicy().hasHeightForWidth())
        self.kElecLE_2.setSizePolicy(sizePolicy1)
        self.kElecLE_2.setAutoFillBackground(False)
        self.kElecLE_2.setStyleSheet(u"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"background-color: rgb(130, 160, 188);\n"
"font-weight: bold")
        self.kElecLE_2.setFrame(True)
        self.kElecLE_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.kElecLE_2.setReadOnly(True)

        self.corrFactorFL_2.setWidget(0, QFormLayout.FieldRole, self.kElecLE_2)

        self.kTPLabel_2 = QLabel(self.scrollAreaWidgetContents_2)
        self.kTPLabel_2.setObjectName(u"kTPLabel_2")

        self.corrFactorFL_2.setWidget(1, QFormLayout.LabelRole, self.kTPLabel_2)

        self.kTPLE_2 = QLineEdit(self.scrollAreaWidgetContents_2)
        self.kTPLE_2.setObjectName(u"kTPLE_2")
        sizePolicy1.setHeightForWidth(self.kTPLE_2.sizePolicy().hasHeightForWidth())
        self.kTPLE_2.setSizePolicy(sizePolicy1)
        self.kTPLE_2.setStyleSheet(u"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"background-color: rgb(130, 160, 188);\n"
"font-weight: bold")
        self.kTPLE_2.setReadOnly(True)

        self.corrFactorFL_2.setWidget(1, QFormLayout.FieldRole, self.kTPLE_2)

        self.kPolLabel_2 = QLabel(self.scrollAreaWidgetContents_2)
        self.kPolLabel_2.setObjectName(u"kPolLabel_2")

        self.corrFactorFL_2.setWidget(2, QFormLayout.LabelRole, self.kPolLabel_2)

        self.kPolLE_2 = QLineEdit(self.scrollAreaWidgetContents_2)
        self.kPolLE_2.setObjectName(u"kPolLE_2")
        sizePolicy1.setHeightForWidth(self.kPolLE_2.sizePolicy().hasHeightForWidth())
        self.kPolLE_2.setSizePolicy(sizePolicy1)
        self.kPolLE_2.setStyleSheet(u"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"background-color: rgb(130, 160, 188);\n"
"font-weight: bold")
        self.kPolLE_2.setReadOnly(True)

        self.corrFactorFL_2.setWidget(2, QFormLayout.FieldRole, self.kPolLE_2)

        self.kSLabel_2 = QLabel(self.scrollAreaWidgetContents_2)
        self.kSLabel_2.setObjectName(u"kSLabel_2")

        self.corrFactorFL_2.setWidget(3, QFormLayout.LabelRole, self.kSLabel_2)

        self.kSLE_2 = QLineEdit(self.scrollAreaWidgetContents_2)
        self.kSLE_2.setObjectName(u"kSLE_2")
        sizePolicy1.setHeightForWidth(self.kSLE_2.sizePolicy().hasHeightForWidth())
        self.kSLE_2.setSizePolicy(sizePolicy1)
        self.kSLE_2.setStyleSheet(u"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"background-color: rgb(130, 160, 188);\n"
"font-weight: bold")
        self.kSLE_2.setReadOnly(True)

        self.corrFactorFL_2.setWidget(3, QFormLayout.FieldRole, self.kSLE_2)


        self.verticalLayout_5.addLayout(self.corrFactorFL_2)

        self.absorsedDoseLabel = QLabel(self.scrollAreaWidgetContents_2)
        self.absorsedDoseLabel.setObjectName(u"absorsedDoseLabel")
        sizePolicy1.setHeightForWidth(self.absorsedDoseLabel.sizePolicy().hasHeightForWidth())
        self.absorsedDoseLabel.setSizePolicy(sizePolicy1)
        ...
        self.zrefDoseLabel_2 = QLabel(self.scrollAreaWidgetContents_2)
        self.zrefDoseLabel_2.setObjectName(u"zrefDoseLabel_2")
        sizePolicy8.setHeightForWidth(self.zrefDoseLabel_2.sizePolicy().hasHeightForWidth())
        self.zrefDoseLabel_2.setSizePolicy(sizePolicy8)

        self.absorbedDoseFL_2.setWidget(0, QFormLayout.LabelRole, self.zrefDoseLabel_2)

        self.zrefDoseLE_2 = QLineEdit(self.scrollAreaWidgetContents_2)
        self.zrefDoseLE_2.setObjectName(u"zrefDoseLE_2")
        sizePolicy1.setHeightForWidth(self.zrefDoseLE_2.sizePolicy().hasHeightForWidth())
        self.zrefDoseLE_2.setSizePolicy(sizePolicy1)
        self.zrefDoseLE_2.setStyleSheet(u"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"background-color: rgb(130, 160, 188);\n"
"font-weight: bold")
        self.zrefDoseLE_2.setReadOnly(True)

        self.absorbedDoseFL_2.setWidget(0, QFormLayout.FieldRole, self.zrefDoseLE_2)

        self.zmaxDoseLabel_2 = QLabel(self.scrollAreaWidgetContents_2)
        self.zmaxDoseLabel_2.setObjectName(u"zmaxDoseLabel_2")
        sizePolicy8.setHeightForWidth(self.zmaxDoseLabel_2.sizePolicy().hasHeightForWidth())
        self.zmaxDoseLabel_2.setSizePolicy(sizePolicy8)

        self.absorbedDoseFL_2.setWidget(1, QFormLayout.LabelRole, self.zmaxDoseLabel_2)

        self.zmaxDoseLE_2 = QLineEdit(self.scrollAreaWidgetContents_2)
        self.zmaxDoseLE_2.setObjectName(u"zmaxDoseLE_2")
        sizePolicy1.setHeightForWidth(self.zmaxDoseLE_2.sizePolicy().hasHeightForWidth())
        self.zmaxDoseLE_2.setSizePolicy(sizePolicy1)
        self.zmaxDoseLE_2.setAutoFillBackground(False)
        self.zmaxDoseLE_2.setStyleSheet(u"background-color: rgb(243, 123, 83);\n"
"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"font-weight: bold\n"
"")
        self.zmaxDoseLE_2.setFrame(False)
        self.zmaxDoseLE_2.setReadOnly(True)

        self.absorbedDoseFL_2.setWidget(1, QFormLayout.FieldRole, self.zmaxDoseLE_2)


        self.verticalLayout_5.addLayout(self.absorbedDoseFL_2)

        self.verticalSpacer_12 = QSpacerItem(4, 18, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        sizePolicy8.setHeightForWidth(self.outcomeLabel.sizePolicy().hasHeightForWidth())
        self.outcomeLabel.setSizePolicy(sizePolicy8)
        ...
        sizePolicy3.setHeightForWidth(self.outcomeHLine.sizePolicy().hasHeightForWidth())
        ...
        self.outcomeLE.setStyleSheet(u"border-radius: 15px;\n"
"padding-left: 15px;\n"
"height: 30px;\n"
"font-weight: bold;\n"
"background-color: rgb(95, 137, 26);\n"
"")
        ...
        self.verticalSpacer = QSpacerItem(4, 10, QSizePolicy.Minimum, QSizePolicy.MinimumExpanding)

        self.calibSummaryVL.addItem(self.verticalSpacer)


        self.worksheetGrid.addLayout(self.calibSummaryVL, 1, 1, 1, 1)

        self.worksheetGrid.setColumnStretch(0, 2)
        self.worksheetGrid.setColumnStretch(1, 1)
        ...
        self.setupSW.setCurrentIndex(0)
    ...
    def retranslateUi(self, QPhotonsWorksheet):
        ...
        self.beamQualityLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p>Beam quality, Q (<span style=\" font-style:italic;\">TPR</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">20,10</span>) :</p></body></html>", None))
        ...
        self.refPhantomLE.setText(QCoreApplication.translate("QPhotonsWorksheet", u"Water", None))
        ...
        self.electCalDateDE.setDisplayFormat(QCoreApplication.translate("QPhotonsWorksheet", u"dd/MM/yyyy", None))
        ...
        self.tempPressCorrLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(A)</span><span style=\" font-style:italic; text-decoration: underline;\"> Temp. and pressure correction</span></p></body></html>", None))
        ...
        self.polarCorrLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(B)</span><span style=\" font-style:italic; text-decoration: underline;\"> Polarity correction</span></p></body></html>", None))
        ...
        self.ionRecombCorrLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(C)</span><span style=\" font-style:italic; text-decoration: underline;\"> Ion recombination correction</span></p></body></html>", None))
        ...
        self.beamQualityCorrLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" text-decoration: underline;\">(D) </span><span style=\" font-style:italic; text-decoration: underline;\">Beam quality correction</span></p></body></html>", None))
        self.beamQCorrFactLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">Q,Qo </span>:</p></body></html>", None))
        self.beamQSourceLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"Acquired from:", None))
        self.table6IIIRadioButton.setText(QCoreApplication.translate("QPhotonsWorksheet", u"Table 6.III", None))
        self.otherSourceRadioButton.setText(QCoreApplication.translate("QPhotonsWorksheet", u"Other", None))
        ...
        self.corrFactorsLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" font-weight:700;\">Correction factors</span></p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.kElecLabel_2.setToolTip(QCoreApplication.translate("QPhotonsWorksheet", u"Electrometer calibration factor", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.kElecLabel_2.setStatusTip("")
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.kElecLabel_2.setWhatsThis("")
        ...
        self.kElecLE_2.setText("")
        self.kElecLE_2.setPlaceholderText(QCoreApplication.translate("QPhotonsWorksheet", u"N/A", None))
#if QT_CONFIG(tooltip)
        self.kTPLabel_2.setToolTip(QCoreApplication.translate("QPhotonsWorksheet", u"Temperature and pressure correction factor", None))
#endif // QT_CONFIG(tooltip)
        self.kTPLabel_2.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">TP </span>:</p></body></html>", None))
        self.kTPLE_2.setText("")
        self.kTPLE_2.setPlaceholderText(QCoreApplication.translate("QPhotonsWorksheet", u"N/A", None))
#if QT_CONFIG(tooltip)
        self.kPolLabel_2.setToolTip(QCoreApplication.translate("QPhotonsWorksheet", u"Polarity correction factor", None))
#endif // QT_CONFIG(tooltip)
        self.kPolLabel_2.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">pol </span>:</p></body></html>", None))
        self.kPolLE_2.setPlaceholderText(QCoreApplication.translate("QPhotonsWorksheet", u"N/A", None))
#if QT_CONFIG(tooltip)
        self.kSLabel_2.setToolTip(QCoreApplication.translate("QPhotonsWorksheet", u"Ion recombination correction factor", None))
#endif // QT_CONFIG(tooltip)
        self.kSLabel_2.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic;\">k</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">s </span>:</p></body></html>", None))
        self.kSLE_2.setPlaceholderText(QCoreApplication.translate("QPhotonsWorksheet", u"N/A", None))
        ...
        self.zrefDoseLabel_2.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p>At reference depth, <span style=\" font-style:italic;\">D</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">w,Q </span>(<span style=\" font-style:italic;\">z</span><span style=\" font-size:12pt; font-style:italic; vertical-align:sub;\">ref </span>) :</p></body></html>", None))
        self.zrefDoseLE_2.setPlaceholderText(QCoreApplication.translate("QPhotonsWorksheet", u"N/A", None))
        self.zmaxDoseLabel_2.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p>At depth of dose max, <span style=\" font-weight:700; font-style:italic;\">D</span><span style=\" font-size:12pt; font-weight:700; font-style:italic; vertical-align:sub;\">w,Q </span><span style=\" font-weight:700;\">(</span><span style=\" font-weight:700; font-style:italic;\">z</span><span style=\" font-size:12pt; font-weight:700; font-style:italic; vertical-align:sub;\">max </span><span style=\" font-weight:700;\">)</span> :</p></body></html>", None))
        self.zmaxDoseLE_2.setText("")
        self.zmaxDoseLE_2.setPlaceholderText(QCoreApplication.translate("QPhotonsWorksheet", u"N/A", None))
