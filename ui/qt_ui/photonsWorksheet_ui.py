...
"")
    ...
    def retranslateUi(self, QPhotonsWorksheet):
        ...
        self.electmeterCorrLabel.setText(QCoreApplication.translate("QPhotonsWorksheet", u"<html><head/><body><p><span style=\" font-style:italic; text-decoration: underline;\">(D) Electrometer correction:</span></p></body></html>", None))
